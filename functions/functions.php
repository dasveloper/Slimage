...
function register_user($first_name, $last_name, $username, $email, $password) {
	...
	if(email_exists($email)) {
		...
		$sql = "INSERT INTO users(first_name, last_name, username, email, password, validation_code, active, apiKey)";
		$sql.= " VALUES('$first_name','$last_name','$username','$email','$hashed_password','$validation_code', 0, '$apiKey')";
		$result = query($sql);
		confirm($result);
...
/****************User login functions ********************/
	...
	function login_user($email, $password, $remember) {
		...
		$sql = "SELECT password, id, apiKey FROM users WHERE email = '".escape($email)."' AND active = 1";
